...
import {Card, ImagePokemon, PokeName, Types} from "../../../entities/pokemons/style/Pokemons.styled.ts";
import {typeColor} from "../../../entities/pokemons/const/const.ts";

export const PokemonCard:React.FC<PokemonCardI> = ({pokemon, onClick}) => {

    const firstType = pokemon.types[0].type.name

    return (
        <Card color={typeColor[firstType]} onClick={()=>onClick(pokemon.name, pokemon)}>
            <div>
